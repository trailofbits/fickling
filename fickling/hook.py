...
class HookManager:
    ...
    def hook_load_with_torch(
        self, load_function, pytorch=False, run_after_analysis=True, block=[3, 4, 5]
    ):
        def wrapper(*args, **kwargs):
            file = args[0]
            return self.core_load_with_torch(
