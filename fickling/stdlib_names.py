"""Top-level standard-library module names across supported Pythons.

Generated by scripts/generate_stdlib_names.py — do not edit by hand;
regenerate instead. Last generated 2026-08-22 16:02 UTC.
...
SHADOWED_STDLIB_MODULE_NAMES: frozenset[str] = frozenset({'aifc', 'asynchat', 'asyncore', 'audioop', 'binhex', 'cgi', 'cgitb', 'chunk', 'crypt', 'distutils', 'imghdr', 'imp', 'lib2to3', 'mailcap', 'msilib', 'nis', 'nntplib', 'ossaudiodev', 'pipes', 'smtpd', 'sndhdr', 'spwd', 'sunau', 'telnetlib', 'uu', 'xdrlib'})
